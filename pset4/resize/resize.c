...
int main(int argc, char *argv[])
{
    ...
    // remember filenames
    int scale_siz = atoi(argv[1]);
    		    
    if (scale_siz < 1 || scale_siz > 100)
    {
   ...
   // create outfile's BITMAPFILEHEADER and BITMAPINFOHEADER
    ...
    out_bi.biWidth *= scale_siz;
    out_bi.biHeight *= scale_siz;
